...
// class CameraScreenDisease extends StatefulWidget {
//   @override
//   _CameraScreenDiseaseState createState() => _CameraScreenDiseaseState();
// }

// class _CameraScreenDiseaseState extends State<CameraScreenDisease> {
...
//       model: 'assets/new_rice_disease/model_unquant.tflite',
//       labels: 'assets/new_rice_disease/labels.txt',
//     );
//     setState(() {
//       isModelLoaded = true;
//     });
...
//       debugPrint('Detected Disease: ${result['label']}');
...
//         title: Text('Rice Disease Detector'),
//       ),
...
//                 children: [
//                   Text(
//                     "Detected Disease: ${(recognitions.isNotEmpty) ? recognitions[0]["label"] : "N/A"}",
//                     style: TextStyle(
//                       color: Colors.white,
//                       fontSize: 18.0,
